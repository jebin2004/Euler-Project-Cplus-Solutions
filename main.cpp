...
int main()
{
    ...
    cout << "Sum of Multiple of 3 or 5: " << multiplesOf3Or5.sumOfMultiplesOf3Or5(10) << endl;

    LargestPrimeFactor largestPrimeFactor;
    cout << "Largest Prime Factor: " << largestPrimeFactor.findLargestPrimeFactor(13195) << endl;
